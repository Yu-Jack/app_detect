...
final class a implements Interpolator
{
    ...
    public final float getInterpolation(final float n) {
        ...
        final int min = Math.min((int)(n * (-1 + android.support.v4.widget.a.b.length)), -2 + android.support.v4.widget.a.b.length);
        return android.support.v4.widget.a.b[min] + (n - min * android.support.v4.widget.a.c) / android.support.v4.widget.a.c * (android.support.v4.widget.a.b[min + 1] - android.support.v4.widget.a.b[min]);
    }
}
