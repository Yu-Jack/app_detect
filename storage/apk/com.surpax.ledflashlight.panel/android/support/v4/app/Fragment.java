...
public class Fragment implements ComponentCallbacks, View$OnCreateContextMenuListener
{
    ...
    private static final l sClassMap;
    ...
    public static Fragment instantiate(final Context context, final String s, final Bundle mArguments) {
        try {
            ...
            throw new d("Unable to instantiate fragment " + s + ": make sure class name exists, is public, and has an empty constructor that is public", ex);
        }
        catch (InstantiationException ex2) {
            throw new d("Unable to instantiate fragment " + s + ": make sure class name exists, is public, and has an empty constructor that is public", ex2);
        }
        catch (IllegalAccessException ex3) {
            throw new d("Unable to instantiate fragment " + s + ": make sure class name exists, is public, and has an empty constructor that is public", ex3);
        }
    }
    
    static boolean isSupportFragmentClass(final Context context, final String name) {
        try {
            Class<?> loadClass = (Class<?>)Fragment.sClassMap.get(name);
            if (loadClass == null) {
    ...
    public void dump(final String s, final FileDescriptor fileDescriptor, final PrintWriter printWriter, final String[] array) {
        ...
        if (this.mLoaderManager != null) {
            ...
            this.mLoaderManager.a(s + "  ", printWriter);
        }
    ...
    public android.support.v4.app.l getLoaderManager() {
        if (this.mLoaderManager != null) {
    ...
    void instantiateChildFragmentManager() {
        (this.mChildFragmentManager = new i()).a(this.mActivity, new g() {
            @Override
    ...
    boolean performContextItemSelected(final MenuItem menuItem) {
        return !this.mHidden && (this.onContextItemSelected(menuItem) || (this.mChildFragmentManager != null && this.mChildFragmentManager.b(menuItem)));
    }
    ...
    boolean performOptionsItemSelected(final MenuItem menuItem) {
        return !this.mHidden && ((this.mHasMenu && this.mMenuVisible && this.onOptionsItemSelected(menuItem)) || (this.mChildFragmentManager != null && this.mChildFragmentManager.a(menuItem)));
    }
    ...
    void performSaveInstanceState(final Bundle bundle) {
        ...
        if (this.mChildFragmentManager != null) {
            final Parcelable f = this.mChildFragmentManager.f();
            if (f != null) {
