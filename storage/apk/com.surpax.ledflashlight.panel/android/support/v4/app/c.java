...
public class c extends Fragment implements DialogInterface$OnCancelListener, DialogInterface$OnDismissListener
{
    ...
    void dismissInternal(final boolean b) {
        ...
        if (this.mBackStackId >= 0) {
            this.getFragmentManager().a(this.mBackStackId);
            this.mBackStackId = -1;
            return;
        }
        final k a = this.getFragmentManager().a();
        a.a(this);
        if (b) {
            a.b();
            return;
    ...
    public int show(final k k, final String s) {
        this.mDismissed = false;
        this.mShownByMe = true;
        k.a(this, s);
        this.mViewDestroyed = false;
        return this.mBackStackId = k.a();
    }
    
    public void show(final h h, final String s) {
        this.mDismissed = false;
        this.mShownByMe = true;
        final k a = h.a();
        a.a(this, s);
