...
public final class Fields
{
    ...
    public static String contentGroup(final int n) {
        return getParam("&cg", n);
    }
    
    public static String customDimension(final int n) {
        return getParam("&cd", n);
    }
    
    public static String customMetric(final int n) {
        return getParam("&cm", n);
    }
    
    private static String getParam(final String s, final int n) {
        if (n < 1) {
            Log.e("index out of range for " + s + " (" + n + ")");
            return "";
        }
        return s + n;
    }
