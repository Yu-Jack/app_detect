...
public abstract class TokenCachingStrategy
{
    ...
    public static void putDeclinedPermissions(final Bundle bundle, final List<String> c) {
        Validate.notNull(bundle, "bundle");
        ...
        bundle.putStringArrayList("com.facebook.TokenCachingStrategy.DeclinedPermissions", list);
    }
    ...
    public static void putPermissions(final Bundle bundle, final List<String> c) {
        Validate.notNull(bundle, "bundle");
        Validate.notNull(c, "value");
        ArrayList list;
        if (c instanceof ArrayList) {
