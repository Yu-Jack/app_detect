...
public class Session implements Serializable
{
    ...
    static /* synthetic */ void access$4(final Session session, final TokenRefreshRequest currentTokenRefreshRequest) {
        session.currentTokenRefreshRequest = currentTokenRefreshRequest;
    }
    
    static /* synthetic */ void access$5(final Session session, final AutoPublishAsyncTask autoPublishAsyncTask) {
        session.autoPublishAsyncTask = autoPublishAsyncTask;
    }
    
    static /* synthetic */ void access$8(final Session session, final AccessToken tokenInfo) {
    ...
    private void requestNewPermissions(final NewPermissionsRequest pendingAuthorizationRequest, final SessionAuthorizationType sessionAuthorizationType) {
        ...
        if (pendingAuthorizationRequest != null) {
            ...
            if (this.state.isOpened()) {
                ...
                this.addCallback(((AuthorizationRequest)pendingAuthorizationRequest).getCallback());
            ...
            public void onCompleted(final Response response) {
                ...
                if (handlePermissionResponse != null) {
                    synchronized (Session.this.lock) {
                        Session.access$8(Session.this, AccessToken.createFromTokenWithRefreshedPermissions(Session.this.tokenInfo, handlePermissionResponse.getGrantedPermissions(), handlePermissionResponse.getDeclinedPermissions()));
