...
public class PlacePickerFragment extends PickerFragment<GraphPlace>
{
    ...
    void setupViews(final ViewGroup viewGroup) {
        if (this.showSearchBox) {
            ...
            (this.searchBox = (EditText)viewGroup.findViewById(R.id.com_facebook_picker_search_text)).addTextChangedListener((TextWatcher)new SearchTextWatcher((SearchTextWatcher)null));
