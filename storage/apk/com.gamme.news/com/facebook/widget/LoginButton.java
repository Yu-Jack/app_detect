...
public class LoginButton extends Button
{
    ...
    static /* synthetic */ void access$12(final LoginButton loginButton, final GraphUser user) {
    ...
    private void checkNuxSettings() {
        ...
        new AsyncTask<Void, Void, Utility.FetchedAppSettings>() {
            private final /* synthetic */ String val$appId = Utility.getMetadataApplicationId(LoginButton.this.getContext());
    ...
    private void finishInit() {
        super.setOnClickListener((View$OnClickListener)new LoginClickListener((LoginClickListener)null));
        this.setButtonText();
        if (!this.isInEditMode()) {
    ...
    public enum ToolTipMode
    {
        ...
        private ToolTipMode(final String name, final int ordinal) {
        }
    }
