...
public abstract class PickerFragment<T extends GraphObject> extends Fragment
{
    ...
    static /* synthetic */ void access$6(final PickerFragment pickerFragment, final boolean appEventsLogged) {
        pickerFragment.appEventsLogged = appEventsLogged;
    }
            ...
            if (this.doneButton != null) {
                this.doneButton.setOnClickListener((View$OnClickListener)new View$OnClickListener() {
                    public void onClick(final View view) {
                        ...
                        PickerFragment.access$6(PickerFragment.this, true);
    ...
    public void setExtraFields(final Collection<String> c) {
        this.extraFields = new HashSet<String>();
        if (c != null) {
            this.extraFields.addAll((Collection<?>)c);
        }
    }
    ...
    void updateAdapter(final SimpleGraphObjectCursor<T> simpleGraphObjectCursor) {
        if (this.adapter != null) {
            ...
            final GraphObjectAdapter.SectionAndItem<T> sectionAndItem = this.adapter.getSectionAndItem(firstVisiblePosition);
            int top;
    ...
    {
        void onError(PickerFragment<?> p0, FacebookException p1);
    }
    
    public interface OnSelectionChangedListener
    {
        void onSelectionChanged(PickerFragment<?> p0);
    }
