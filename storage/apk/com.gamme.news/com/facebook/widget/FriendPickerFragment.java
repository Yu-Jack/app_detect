...
public class FriendPickerFragment extends PickerFragment<GraphUser>
{
    ...
    public void setSelection(final GraphUser... a) {
        this.setSelection(Arrays.asList(a));
    }
    ...
    public void setSelectionByIds(final String... a) {
        this.setSelectionByIds(Arrays.asList(a));
    }
