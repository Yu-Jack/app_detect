...
class AuthorizationClient implements Serializable
{
    ...
    class KatanaProxyAuthHandler extends KatanaAuthHandler
    {
        ...
        private Result handleResultOk(final Intent intent) {
            ...
            if (s == null && string == null && s2 == null) {
                ...
                final boolean contains = ServerProtocol.errorsProxyAuthDisabled.contains(s);
                tokenResult = null;
                if (!contains) {
        ...
        boolean tryAuthorize(final AuthorizationRequest authorizationRequest) {
            ...
            final Intent proxyAuthIntent = NativeProtocol.createProxyAuthIntent(AuthorizationClient.this.context, authorizationRequest.getApplicationId(), authorizationRequest.getPermissions(), access$0, authorizationRequest.isRerequest());
    ...
    class WebViewAuthHandler extends AuthHandler
    {
        ...
        boolean tryAuthorize(final AuthorizationRequest authorizationRequest) {
            ...
            (this.loginDialog = ((WebDialog.Builder)((WebDialog.Builder)new AuthDialogBuilder((Context)AuthorizationClient.this.getStartActivityDelegate().getActivityContext(), this.applicationId, bundle).setE2E(this.e2e).setIsRerequest(authorizationRequest.isRerequest())).setOnCompleteListener(onCompleteListener)).build()).show();
            return true;
        }
    }
}
