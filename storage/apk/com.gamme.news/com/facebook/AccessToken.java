...
public final class AccessToken implements Serializable
{
    ...
    AccessToken(final String token, final Date expires, List<String> emptyList, List<String> emptyList2, final AccessTokenSource source, final Date lastRefresh) {
        if (emptyList == null) {
        ...
        this.declinedPermissions = (List<String>)Collections.unmodifiableList((List<?>)emptyList2);
        this.token = token;
        this.source = source;
    ...
    static AccessToken createFromWebBundle(List<String> list, final Bundle bundle, final AccessTokenSource accessTokenSource) {
        ...
        return createNew((List<String>)list, list2, string, bundleLongAsDate, accessTokenSource);
    }
