...
public class ExifHelper
{
    ...
    public void createInFile(final String s) throws IOException {
        this.inFile = new ExifInterface(s);
    }
    
    public void createOutFile(final String s) throws IOException {
        this.outFile = new ExifInterface(s);
    }
    
    public int getOrientation() {
        final int int1 = Integer.parseInt(this.orientation);
        if (int1 != 1) {
            if (int1 == 6) {
                return 90;
            }
