...
final class BakedBezierInterpolator implements Interpolator
{
    ...
    static {
        ...
        STEP_SIZE = 1.0f / (-1 + BakedBezierInterpolator.VALUES.length);
    }
    
    public static final BakedBezierInterpolator getInstance() {
        return BakedBezierInterpolator.INSTANCE;
    }
    ...
    public float getInterpolation(final float n) {
        ...
        final int min = Math.min((int)(n * (-1 + BakedBezierInterpolator.VALUES.length)), -2 + BakedBezierInterpolator.VALUES.length);
        return BakedBezierInterpolator.VALUES[min] + (n - min * BakedBezierInterpolator.STEP_SIZE) / BakedBezierInterpolator.STEP_SIZE * (BakedBezierInterpolator.VALUES[min + 1] - BakedBezierInterpolator.VALUES[min]);
    }
}
