...
class TransportMediatorJellybeanMR2 implements RemoteControlClient$OnGetPlaybackPositionListener, RemoteControlClient$OnPlaybackPositionUpdateListener
{
    ...
    void windowAttached() {
        ...
        (this.mRemoteControl = new RemoteControlClient(this.mPendingIntent)).setOnGetPlaybackPositionListener((RemoteControlClient$OnGetPlaybackPositionListener)this);
