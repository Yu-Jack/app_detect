...
public class MenuItemCompat
{
    ...
    {
        boolean collapseActionView(MenuItem p0);
        
        boolean expandActionView(MenuItem p0);
        
        View getActionView(MenuItem p0);
        
        boolean isActionViewExpanded(MenuItem p0);
        
        MenuItem setActionView(MenuItem p0, int p1);
        
        MenuItem setActionView(MenuItem p0, View p1);
        
        MenuItem setOnActionExpandListener(MenuItem p0, OnActionExpandListener p1);
        
        void setShowAsAction(MenuItem p0, int p1);
    }
