...
public class ViewCompat
{
    ...
    interface ViewCompatImpl
    {
        ...
        int getAccessibilityLiveRegion(View p0);
        ...
        int getMeasuredHeightAndState(View p0);
        
        int getMeasuredState(View p0);
        
        int getMeasuredWidthAndState(View p0);
        ...
        int resolveSizeAndState(int p0, int p1, int p2);
        
        void setAccessibilityDelegate(View p0, AccessibilityDelegateCompat p1);
        
        void setAccessibilityLiveRegion(View p0, int p1);
