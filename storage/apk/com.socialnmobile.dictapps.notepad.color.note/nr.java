...
public final class nr implements Runnable
{
    ...
    public nr(final ListEditor a, final ArrayList b) {
        this.a = a;
        this.b = b;
    }
    ...
    public final void run() {
        if (this.b.get(ListEditor.h(this.a)).a.trim().equals("")) {
            this.b.remove(ListEditor.h(this.a));
            if (this.b == ListEditor.a(this.a)) {
                this.a.aq();
            }
        }
    }
