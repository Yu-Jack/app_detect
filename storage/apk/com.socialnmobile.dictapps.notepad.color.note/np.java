...
public final class np implements Runnable
{
    ...
    public np(final ListEditor a, final String b) {
        this.a = a;
        this.b = b;
    }
    ...
    public final void run() {
        if (this.b.equals("")) {
            ListEditor.a(this.a).remove(ListEditor.h(this.a));
        }
        else {
            ListEditor.a(this.a).get(ListEditor.h(this.a)).a(this.b);
            this.a.a.post((Runnable)new nq(this));
        }
        this.a.aq();
    }
}
