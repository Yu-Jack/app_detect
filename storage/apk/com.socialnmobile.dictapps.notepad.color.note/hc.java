...
public final class hc implements lh
{
    final /* synthetic */ BackupLocal a;
    
    public hc(final BackupLocal a) {
        this.a = a;
    }
    ...
    public final boolean a(final String s) {
        ...
        if (this.a.a(s, this.a.d.e, this.a.d.f)) {
            ColorNote.a(this.a.getApplicationContext(), "BACKUP", "RESTORE");
            final BackupLocal a = this.a;
            final BackupLocal a2 = this.a;
            new hk(a, s, this.a.d, 1).execute((Object[])new String[0]);
            return true;
        }
        return false;
    }
