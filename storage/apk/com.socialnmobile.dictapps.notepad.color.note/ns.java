...
public final class ns implements Runnable
{
    ...
    public ns(final ListEditor a, final String b, final ArrayList c) {
        this.a = a;
        this.b = b;
        this.c = c;
    }
    ...
    public final void run() {
        if (this.b.equals("")) {
            this.c.remove(ListEditor.h(this.a));
        }
        else {
            this.c.get(ListEditor.h(this.a)).a(this.b);
        }
        if (this.c == ListEditor.a(this.a)) {
            this.a.aq();
        }
    }
}
