...
public class m implements Parcelable$Creator<TrashResourceRequest>
{
    static void a(final TrashResourceRequest trashResourceRequest, final Parcel parcel, final int n) {
        ...
        c.a(parcel, 2, (Parcelable)trashResourceRequest.b, n, false);
        c.a(parcel, a);
    }
    
    public TrashResourceRequest a(final Parcel parcel) {
    ...
    public TrashResourceRequest[] a(final int n) {
