...
public class w implements Parcelable$Creator<GetMetadataRequest>
{
    static void a(final GetMetadataRequest getMetadataRequest, final Parcel parcel, final int n) {
        ...
        c.a(parcel, 2, (Parcelable)getMetadataRequest.b, n, false);
        c.a(parcel, a);
    }
    
    public GetMetadataRequest a(final Parcel parcel) {
    ...
    public GetMetadataRequest[] a(final int n) {
