...
public class ShareCompat$IntentBuilder
{
    ...
    private void combineArrayExtra(final String s, final ArrayList<String> list) {
        ...
        final String[] a = new String[length + list.size()];
        list.toArray(a);
        if (stringArrayExtra != null) {
    ...
    public ShareCompat$IntentBuilder addEmailBcc(final String e) {
    ...
    public ShareCompat$IntentBuilder addEmailCc(final String e) {
    ...
    public ShareCompat$IntentBuilder addEmailTo(final String e) {
    ...
    public ShareCompat$IntentBuilder addStream(final Uri uri) {
